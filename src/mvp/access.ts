...
const teamNav=[item('Home','خانه'),item('Team outcomes','پیامدها و اهداف تیم'),item('People','اعضای تیم'),item('Project snapshot','صف نمای پروژه'),item('Attribution','تشخیص انتساب'),item('System quality','کیفیت سیستم کاری')];
...
export function buildContexts(db:DB):AppContext[]{
 ...
 return [
  ...
  ...managerContexts(db),
  {id:'hris',label:'HRIS — منابع انسانی و ساختار',roleTitle:'مسئول HRIS',scope:'همه تیم‌ها، پروژه‌ها، مدل، دوره و کیفیت',engineRole:'HRIS',nav:[item('Home','خانه'),item('Team project queue','صف‌بندی تیم و پروژه'),item('Job families','خانواده‌های شغلی'),item('Performance profiles','پروفایل‌های عملکرد'),item('Model & policy','وزن‌ها و سیاست'),item('Data & controls','دوره‌های ارزیابی'),item('Calibration','آمادگی انتشار'),item('Quality samples','صف نمونه‌های کیفیت'),item('Quality review','بازبینی شواهد')]},
